...
.. argparse::
   ...
   The ``--include-global-rule-cfn-resources`` flag can be used to deploy (not just regional, but also global) rule dependencies or add-ons with custom CloudFormation templates in yaml or json format.
